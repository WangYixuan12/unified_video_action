...
class TrainUnifiedVideoActionWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if cfg.task.task_type == "multiple_datasets":
            ...
            if cfg.task.dataset._target_ in [
                'unified_video_action.dataset.kf_dataset.KFDataset',
                'unified_video_action.dataset.sim_aloha_dataset.SimAlohaDataset',
                'unified_video_action.dataset.dinowm_pusht_dataset.DINOWMPushTDataset',
            ]:
